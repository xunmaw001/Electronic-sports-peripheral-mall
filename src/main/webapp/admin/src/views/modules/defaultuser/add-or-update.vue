  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.name" label="姓名" prop="name">
              <el-input v-model="ruleForm.name" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.sex" label="性别" prop="sex">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.age" label="年龄" prop="age">
              <el-input v-model="ruleForm.age" 
          ...
          <el-form-item class="input" v-if="ruleForm.phone" label="电话" prop="phone">
              <el-input v-model="ruleForm.phone" 
                placeholder="电话" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="照片" prop="picture">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.email" label="邮箱" prop="email">
              <el-input v-model="ruleForm.email" 
