  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">电子竞技周边商城注册</h1>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                        ...
                                                                        if(`defaultuser` == this.tableName && this.ruleForm.phone&&(!this.$validate.isMobile(this.ruleForm.phone))){
